        ...
        <div class="ball-scroll-box">
          <div class="ball-scroll" v-if="gameData.length > 0">
            <scroller lock-y :scrollbar-x=false>
              <div class="list">
                <div :style="{color:$route.path == '/morning/'+item.category ? '#EBA01E' : '#585757'}" v-for="(item,key) in gameData" :key='item.id' @click='clickBall(item.category,key,item.cnName,item.enName)' :class="[{'active':getActive[item.category]}, item.ballType, 'item rs-'+item.enName ]">
                    ...
                    <i :style="{color:$route.path == '/morning/'+item.category ? '#EBA01E' : '#585757'}" :class='["iconfont icon-"+item.enName]'></i>
          ...
          <div class="ball-title rs-football">
            ...
            <!--<tab :animate="clearanceIsShow" class='ball-tab' :line-width="2" >  &lt;!&ndash;custom-bar-width="70px"&ndash;&gt;-->
              <!--<tab-item  @on-item-click="singleOrClearance" :selected="isMix == 0 && clearanceIsShow">-->
                <!--{{-->
                  <!--ballType === "TYWQ" ? "独赢&让盘":-->
                  <!--ballType === "TYPQ" ? "独赢&让局": "让球&大小"-->
                <!--}}-->
              <!--</tab-item>-->
              <!--<tab-item v-if="clearanceIsShow" @on-item-click="singleOrClearance" :selected="isMix === 1">综合过关</tab-item>-->
              <!--<tab-item v-if="championIsShow" @on-item-click="singleOrClearance" :selected="isMix === 2">冠军</tab-item>-->
            <!--</tab>-->
...
<script src="../../js/morning/morning.js"></script>
