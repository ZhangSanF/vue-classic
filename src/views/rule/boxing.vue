<template>
  <div class="rule-info"><!--资料区-->
    ...
    <ul class="ul-decimal">
      ...
      <li>注单的结算将根据比赛公布的结果为准，比赛结果可以以点数，技术性击倒，击倒或剥夺资格来定义。
    ...
    <div class="maindiv">
      <p class="b sub">搏斗（综合格斗）</p>
      <p class="b sub"><em>最后更新日期：19/6/2012</em></p>
      <p class="b sub">一般规则</p>
      <ul class="ul-decimal">
        ...
        <li>比赛后公布的结果将视为最终赛果并且可以以得分，降服，技术性击倒，击倒或剥夺资格来定义。如果赛果在比赛结束并且拳击手离开擂台后有任何修正或修改将被视为无效。
          <ul style="list-style:lower-alpha">
