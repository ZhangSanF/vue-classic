<template>
  <div class="rule-info"><!--资料区-->
    <p class="b sub">板球</p>
    <p class="b sub"><em>最后更新日期：05/07/2017</em></p>
    ...
    <ul style="list-style:decimal;">
      ...
      <li>如是采用达-路方法(Duckworth Lewis Method - DL)计算，所有投注在"最多轮数"，"最高配对选手开场得分"，”击球手賽事”及”投球手賽事”的注单将被取消，除非在采用D/L计算方式前已有明确结果并且之后没有任何显著会影响赛事结果的情况。”击球手”及”投球手”赛事在采用达-路方法(Duckworth Lewis Method - DL)之后所开的盘将由新的轮数来结算。</li>
