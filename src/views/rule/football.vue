<template>
  <div class="rule-info"><!--资料区-->
    <p class="b sub">足球</p>
    <p class="b sub"><em>最后更新日期：11/07/2017</em></p>
    <p>
      <!-- buttons -->
    </p>
    <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
      <tbody>
      <tr>
        <td><a href="#General Rules">
          <div class="football_buttons">一般规则</div>
        </a></td>
        <td><a href="#mainmarkets">
          <div class="football_buttons">主要市场</div>
        </a></td>
        <td><a href="#GoalMarkets">
          <div class="football_buttons">进球集锦</div>
        </a></td>
      </tr>
      <tr>
        <td><a href="#PlayersMarkets">
          <div class="football_buttons">球员</div>
        </a></td>
        <td><a href="#Specials">
          <div class="football_buttons">特别</div>
        </a></td>
        <td><a href="#Corners">
          <div class="football_buttons">角球</div>
        </a></td>
      </tr>
      <tr>
        <td><a href="#BookingsCards">
          <div class="football_buttons">牌/卡</div>
        </a></td>
        <td><a href="#FreeKicks">
          <div class="football_buttons">任意球</div>
        </a></td>
        <td><a href="#GoalKicks">
          <div class="football_buttons">射门</div>
        </a></td>
      </tr>
      <tr>
        <td><a href="#ThrowIns">
          <div class="football_buttons">界外球</div>
        </a></td>
        <td><a href="#Substitutions">
          <div class="football_buttons">替换</div>
        </a></td>
        <td><a href="#Offsides">
          <div class="football_buttons">越位</div>
        </a></td>
      </tr>
      <tr>
        <td><a href="#PenaltyMarkets">
          <div class="football_buttons">点球</div>
        </a></td>
        <td><a href="#Competitions">
          <div class="football_buttons">比赛</div>
        </a></td>
        <td><a href="#OtherMarkets">
          <div class="football_buttons">其他</div>
        </a></td>
      </tr>
      </tbody>
    </table>
    ...
    <p></p>
    <!-- general rules -->
    <div class="quick_link" id="General Rules">一般规则</div>
    <div class="content_inner">
      <ul class="ul-decimal">
        <li>除非另有注明，所有足球投注的结算皆以球赛所规定的完场时间90分钟为准。 <br>
        </li>
        <li>完场时间90分钟包括球员伤停补时。加时赛、淘汰赛、点球，以及赛事后如果裁判或相关管理机构更改任何赛果则不计算在内。 <br>
        </li>
        <li>除非在个别玩法规则另有注明，所有滚球投注的结算将以90分钟的赛果为准。 <br>
        </li>
        <li>对于某些以全场完场时间为80分钟（2 x40分钟）的特定赛事或者友谊赛，所有投注的结算皆以完场时间为准。 <br>
        </li>
        <li>若少年赛、友谊赛的完场时间为70分钟（2 x 35分钟）或更少，本公司将在开赛前做出公布，否则该场赛事的注单一律作废。<br></li>
        <li>如果赛事中断或延迟，并且没有在36小时内重新开始，所有该场赛事的投注即被视为无效且取消，除非在个别投注类型规则里另有指定注明。<br></li>
        <li>
          如果赛事确认取消，所有该场赛事的投注即被视为无效且取消，除非在个别投注类型规则里另有指定注明。如果赛事是在上半场中断，所有上半场的注单将被取消。如果赛事是在下半场中断所有上半场的投注保持有效，但所有下半场的注单将被取消，除非在个别玩法规则另有注明。
          <br></li>
        <li>除非在个别玩法规则另有注明，乌龙球将予以计算在内。<br></li>
        <li>如果比赛或赛事取消，中断或延迟并且没有在官方指定开球时间的36小时内重新开始，所有该场赛事的投注即被视为无效且取消，除非在个别体育规则里另有指定注明。
          某些无条件终止的盘口将会相应地结算。单独的体育规则中对此类盘口的结算程序做了说明。公司取消该赛事所有注单的结果被视为最终决定，无需参考官方赛事裁判或相关部门的决定。连串投注将会继续按照注单剩余赛事的赛果结算，该取消赛事的赔率将会按照1计算。
          <br></li>
        <li>对于国际赛事，只要变更的场地仍在同一个国家内，所有注单将保持有效。<br></li>
        <li>对于国际赛事，只要变更的场地仍在联赛原定举办的国家内，所有注单将保持有效。<br></li>
    ...
    <div class="content_inner">
      ...
      <p><strong>15</strong><strong>分钟进球数（让球）</strong></p>
      <ul class="ul-decimal">
        <li>根据盘口让球信息预测最终获得15分钟内比赛胜利的球队。</li>
        <li>在每个15分钟开始，所有球队在开始此时段比赛都是0-0，之前的得分点是没有影响的。</li>
        <li>所有的投注将以开始下个时节前的赛果结算。</li>
        <li>如果赛事中断，所有当前15分钟时段的投注以及将要进行的下一个15分钟时段投注将视为无效，任何15分钟时段投注，如果该时段完整结束，注单将被视为有效。
          <table width="100%" border="0" cellspacing="1" cellpadding="0">
            <tbody>
            <tr class="tabledetail">
              <td class="center" width="50%">15分钟-时段1</td>
              <td class="center" width="50%">上半场开始-14分59秒</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">15分钟-时段2</td>
              <td class="center">15分钟-29分59秒</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">15分钟-时段3</td>
              <td class="center">30分钟-半场</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">15分钟-时段4</td>
              <td class="center">下半场开始-59分59秒</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">15分钟-时段5</td>
              <td class="center">60分钟-74分59秒</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">15分钟-时段6</td>
              <td class="center">75分钟-全场</td>
            </tr>
            </tbody>
          </table>
        </li>
      </ul>
      <p><strong>大小盘</strong></p>
      <br>
      <p><strong>一般规则</strong></p>
      <ul class="ul-decimal">
      ...
      <ul start="5">
        <li>如果赛事中断前已有明确结果并且之后没有任何显著会影响赛事结果的情况，大/小盘注单才会被结算。若遇到任何其他情况，注单将一律被取消。请参考以上范例：
          <ul class="ul-alpha">
            <li>
              范例1：会员投注大于2.5球：
              <ul type="i">
      ...
      <p><strong>&nbsp;滚球大小盘</strong></p>
      <ul class="ul-decimal">
        <li>结算是以比赛/时节结束后的总入球数做裁决。投注当时，赛事的比分将视为0-0来计算。</li>
      </ul>
      <p><strong>加时赛 - 进球: 大 / 小</strong></p>
      <ul class="ul-decimal">
      ...
      <ul class="ul-decimal">
        ...
        <li> 如果比赛被中断，所有将要进行的15分钟时段投注将被视为无效。任何15分钟时段投注，如果该时段中赛事进行完整，此注单将被视为有效。在15分钟时段中，如果赛事已有明确结果并且之后对赛事没有任何影响，总进球数大/小盘注单才会被结算。任何其他的情况，投注将被视为无效。
          <table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr class="tabledetail">
              <td class="center">15分钟-时段6</td>
              <td class="center">75分钟-全场结束</td>
            </tr>
            </tbody>
          </table>
        </li>
      </ul>
      <p><strong>加时赛 - 5 分钟进球数 (大 / 小)</strong></p>
      <ul class="ul-decimal">
        <li>预测赛事总入球数将大于或小于在盘口指定的大/小盘球数。</li>
        <li>如果总进球数多于盘口的大/小盘牌数，则为大盘。如果少于盘口的大/小盘牌数，则为小盘。</li>
        <li>在每个5分钟时开始，所有球队在开始此时节比赛都是0-0，之前的得分是没有影响的。</li>
        <li>如果比赛被中断，所有将要进行的5分钟时段投注将被视为无效。任何5分钟时段投注，如果该时段中赛事进行完整，此注单将被视为有效。在5分钟时段中，如果赛事已有明确结果并且之后对赛事没有任何影响，总进球数大/小盘注单才会被结算。任何其他的情况，投注将被视为无效。
          <table width="100%" border="0" cellspacing="1" cellpadding="0">
            <tbody>
            <tr class="tabledetail">
              <td class="center" width="50%">5分钟-时段1</td>
              <td class="center" width="50%">上半场开始-04分59秒</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">5分钟-时段2</td>
              <td class="center">05分钟-09分59秒</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">5分钟-时段3</td>
              <td class="center">10分钟-半场结束</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">5分钟-时段4</td>
              <td class="center">下半场开始-19分59秒</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">5分钟-时段5</td>
              <td class="center">20分钟-24分59秒</td>
            </tr>
            <tr class="tabledetail">
              <td class="center">5分钟-时段6</td>
              <td class="center">25分钟-全场结束</td>
            </tr>
            </tbody>
          </table>
        </li>
      </ul>
      <p><strong>1 X 2（独赢盘）</strong></p>
      <p><strong>一般规则</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在比赛胜出。盘口提供两支球队和平局为投注选项。</li>
        <li>投注将以0-0的比分作为计算基础（让球并不计算在内）。 </li>
      </ul>
      <p><strong>独赢</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在90分钟比赛胜出或赛事和局。</li>
      </ul>
      <p><strong>独赢 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>所有上半场的投注将以上半场45分钟赛果结算。</li>
      </ul>
      <p><strong>滚球独赢</strong></p>
      <ul class="ul-decimal">
        <li>
          <p>预测滚球时，哪一支球队胜出。</p></li>
        <br>
        <li><p>投注的结算将以90分钟完场赛果为准。 </p></li>
        <br>
        <li> 以下为滚球独赢盘范例。</li>
      </ul>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr class="tabledetail">
          <td class="center">阿森纳（主）</td>
          <td class="center">1</td>
          <td class="center">1.61</td>
        </tr>
        <tr class="tabledetail">
          <td class="center">曼联</td>
          <td class="center">0</td>
          <td class="center">6.0</td>
        </tr>
        <tr class="tabledetail">
          <td class="center">和局</td>
          <td class="center">&nbsp;</td>
      ...
      <ul class="foot_ml">
        ...
        <p><strong>进球数: 单 / 双 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测45分钟赛事的总入球数是单数或双数。</li>
          <li>若最终比分为：0-0，将会按照“双”来计算。</li>
        </ul>
        <p><strong>加时赛 - 进球数: 单 / 双</strong></p>
        <ul class="ul-decimal">
          <li>预测加时30分钟赛事的总入球数是单数或双数，包含补时。</li>
          <li>若最终比分为：0-0，将会按照“双”来计算。</li>
        </ul>
        <p><strong>加时赛 - 进球数: 单 / 双 -上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测加时赛15分钟内的总进球数是单数或双数，包括补时。</li>
          <li>若最终比分为：0-0，将会按照“双”来计算。</li>
        </ul>
        <p><strong>15分钟进球数 (单 / 双)</strong></p>
        <ul class="ul-decimal">
          <li>预测在规定时间内进球数是单或双。</li>
          <li>所有两支球队在每时段开始时比分将按照0-0计算，之前比分不计算在内。</li>
          <li>如果赛事中断，所有当前15分钟时段的投注以及将要进行的下一个15分钟时段投注将视为无效，任何15分钟时段投注，如果该时段完整结束，注单将被视为有效。</li>
          <table width="100%" border="0" cellspacing="1" cellpadding="0">
            <tbody>
            <tr class="tabledetail">
              <td class="center" width="50%">15分钟-时段1</td>
    ...
    <!-- goal rules -->
    <div class="quick_link" id="GoalMarkets">进球集锦</div>
    <div class="content_inner">
      ...
      <ul class="foot_ml">
        ...
        <p><strong>总进球数 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测半场两队的总入球数。</li>
          <li>如果注单在赛事中断前已得到明确的胜负，并且任何进一步的赛果均不会对注单结果产生影响的情况下，注单会被视为有效。</li>
        </ul>
      </ul>
      <p><strong>单一球队总入球数</strong></p>
      <ul class="ul-decimal">
        <li>预测其中一支球队的总入球数。</li>
        <li>如果赛事中断前，注单已得到明确结果并且之后没有任何显著会影响赛事结果的情况注单会有被结算 。若遇到任何其他情况，注单将一律被取消。</li>
      </ul>
      <p><strong>最先/最后进球</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>X 进球</strong><strong>(下一个进球)</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>零失球</strong></p>
      <ul class="ul-decimal">
        <li>预测某个球队在90分钟的比赛中，没有任何进球。</li>
        <li>选择投注球队不需要赢得比赛，例如：赛果 0-0，注单为赢。</li>
      </ul>
      <p><strong>零失球获胜</strong></p>
      <ul class="ul-decimal">
        <li>预测您投注的球队在90分钟完场时间内没有失球及没让敌方攻入任何一球。</li>
        <li>无失球'是指球队在赛事中没让敌方攻入任何一球，争取完美防守。</li>
      </ul>
      <p><strong>先进</strong><strong>2</strong><strong>球</strong><strong>/3</strong><strong>球的一方</strong></p>
      <ul class="ul-decimal">
        <li>预测在90分钟完场时间内哪个球队先进2/3球。</li>
        <li>如果赛事在一方球队已经进2/3球后中断，所有注单将保持有效。</li>
      </ul>
      <p><strong>最多进球的半场</strong></p>
      <ul class="ul-decimal">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tbody>
        <tr class="tabledetail">
          <td class="center" width="50%">选项 1</td>
          <td class="center" width="50%">小于等于26分钟</td>
        </tr>
        <tr class="tabledetail">
          <td class="center">选项 2</td>
          <td class="center">大于或等于27分钟</td>
        </tr>
        <tr class="tabledetail">
          <td class="center">选项 3</td>
          <td class="center">没有进球</td>
        </tr>
        </tbody>
      </table>
      <ul start="3">
    ...
    <!-- Player Markets rules -->
    <div class="quick_link" id="PlayersMarkets">球员</div>
    <div class="content_inner">
      <p><strong>最先进球球员</strong></p>
      <ul class="ul-decimal">
    ...
    <div class="content_inner">
      ...
      <p><strong>双半场总伤停补时—大</strong><strong>/</strong><strong>小</strong></p>
      <ul class="ul-decimal">
    ...
    <div class="content_inner">
      ...
      <ul class="ul-decimal">
        <li>预测哪一支球队将在45分钟比赛内获得更多角球数，盘口提供两支球队和平局为投注选项。</li>
        <li>如果赛事在上半场中断，所有注单将被视为无效，除非赛事已有明确结果并且之后的角球对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，所有投注上半场角球独赢盘将会被视为有效。</li>
      </ul>
      <p><strong>角球 - X角球</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>15</strong><strong>分钟角球数</strong></p>
      <ul class="ul-decimal">
    ...
    <!-- general rules -->
    <div class="quick_link" id="BookingsCards">牌/卡</div>
    <br>
    <div class="content_inner">
      <p><strong>罚牌：一般规则</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>罚牌数: 独赢</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在90分钟比赛内获得最多罚牌，盘口提供两支球队和平局为投注选项。</li>
        <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且之后罚牌对赛事没有任何影响。</li>
      </ul>
      <p><strong>罚牌数: 独赢 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在45分钟比赛内获得最多罚牌，盘口提供两支球队和平局为投注选项。</li>
        <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后罚牌对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。</li>
      </ul>
      <p><strong>罚牌数: 单 / 双</strong></p>
      <ul class="ul-decimal">
        <li>预测90分钟内赛事的总罚牌数是单数或双数。</li>
        <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且之后罚牌对赛事没有任何影响。</li>
        <li>若比赛没有罚牌，比分为0，投注‘双’注单将会盈利。</li>
      </ul>
      <p><strong>罚牌数: 单 / 双 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测45分钟内赛事的总罚牌数是单数或双数。</li>
        <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后罚牌对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。</li>
        <li>若比赛没有罚牌，结果0-0，投注‘双’注单将会盈利。<br>
        </li>
      </ul>
      <p><<strong>第一张/最后一张罚牌</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>15</strong><strong>分</strong><strong>钟罚牌数</strong></p>
      <ul class="ul-decimal">
        <li>依照以上主要市场陈列的15分钟规则，预测哪队将在让球，独赢，大小或单双盘口取得胜利。</li>
      </ul>
    </div>
    ...
    <!-- general rules -->
    <div class="quick_link" id="FreeKicks">任意球</div>
    <div class="content_inner">
      <p><strong>任意球：一般规则</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>任意球：让球</strong></p>
      <ul class="ul-decimal">
        <li>预测在90分钟完场时间内哪一支球队在盘口指定的让球数发出最多任意球。</li>
        <li>所有注单将按盘口开出的让球数在相应玩法结束后结算。</li>
        <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且之后任意球对赛事没有任何影响。</li>
      </ul>
      <p><strong>任意球: 让球 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测在45分钟完场时间内哪一支球队在盘口指定的让球数发出最多任意球。</li>
        <li>所有注单将按盘口开出的让球数在相应玩法结束后结算。</li>
        <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后任意球对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。</li>
      </ul>
      <p><strong>任意球: 大 / 小</strong></p>
      <ul class="ul-decimal">
        <li>预测90分钟内总发出的任意球数将大于或小于在盘口指定的大/小盘牌数。</li>
      ...
      <p><strong>任意球: 大 / 小 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测45分钟内总发出的任意球数将大于或小于在盘口指定的大/小盘牌数。</li>
        <li>如果任意球数多于盘口的大/小盘牌数，则为大盘。如果少于盘口的大/小盘牌数，则为小盘。</li>
        <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后任意球对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，那么所有投注该注单均视为有效。</li>
      </ul>
      <p><strong>任意球: 独赢</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在90分钟比赛获得更多任意数，盘口提供平局投注。</li>
        <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且之后任意球对赛事没有任何影响。</li>
      </ul>
      <p><strong>任意球: 独赢 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在45分钟比赛内获得更多任意球，盘口提供平局投注。</li>
        <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后任意球对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。<br>
        </li>
      </ul>
      <p><strong>任意球: 单 / 双</strong></p>
      <ul class="ul-decimal">
        <li>预测90分钟内赛事的总任意球数是单数或双数。</li>
        <li>若比赛没有任意球，结果为0，投注‘双’注单将会盈利。</li>
        <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且之后任意球对赛事没有任何影响。</li>
      </ul>
      <p><strong>任意球: 单 / 双 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测45分钟内赛事的总任意球数是单数或双数。</li>
        <li>若比赛没有任意球，结果为：0，投注‘双’注单将会盈利。</li>
        <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后任意球对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，那么所有投注该注单均视为有效。</li>
      </ul>
      <p><strong>最先/最后任意球</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>最多任意球球队</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将发出最多任意球。</li>
        <li>注单将按照90分钟完场赛事时间内发出最多任意球的球队做结算。</li>
        <li>选项可列为：</li>
        <ul class="ul-alpha">
          <li>球队A</li>
          <li>球队B</li>
      ...
      <ul class="ul-decimal">
        ...
        <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。</li>
        <li>范例：如果投注首个任意球时间的选项是‘赛事的第8分钟或之前’，而确实发出任意球的时间为8分钟49秒，任意球发出时间的范围属于‘第9分钟后’，因此投注将结算为输。</li>
    ...
    <!-- general rules -->
    <div class="quick_link" id="GoalKicks">射门</div>
    <br>
    <div class="content_inner">
      <p><strong>球门球：一般规则</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>球门球：让球</strong></p>
      <ul class="ul-decimal">
        <li>预测在90分钟完场时间内哪一支球队在盘口指定的让球数发出最多球门球。</li>
        <li>所有注单将按盘口开出的让球数在相应玩法结束后结算。</li>
      </ul>
      <p><strong>球门球: 让球 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测在45分钟完场时间内哪一支球队根据盘口开出让球信息获得球门球次数最多。</li>
        <li>所有注单将按盘口开出的让球数在相应玩法结束后结算。</li>
        <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，那么所有投注该注单均视为有效。</li>
      </ul>
      <p><strong>球门球: 大 / 小</strong></p>
      <ul class="ul-decimal">
        <li>预测在90分钟内总发出的球门球数将大于或小于在盘口指定的大/小盘牌数。</li>
      ...
      <p><strong>球门球: 大 / 小 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测45分钟内总球门球次数将大于或小于在盘口指定的大/小盘牌数。</li>
        <li>如果总球门球个数大于盘口的大/小盘牌数，则为大盘。如果小于盘口的大/小盘牌数，则为小盘。</li>
        <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后的球门球对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，那么所有投注该注单均视为有效。</li>
      </ul>
      <p><strong>球门球: 独赢</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在90分钟比赛内获得更多的球门球，盘口提供平局投注。</li>
        <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且对赛事没有任何影响。</li>
      </ul>
      <p><strong>球门球: 独赢 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在45分钟比赛内获得更多的球门球，盘口提供平局投注。</li>
        <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果对赛事没有任何影响。</li>
        <li>如果赛事在下半场中断，那么所有投注该注单均视为有效。</li>
      </ul>
      <p><strong>球门球: 单 / 双</strong></p>
      <ul class="ul-decimal">
        <li>预测90分钟内赛事的总球门球个数是单数或双数。</li>
        <li>若比赛没有球门球，结果为0，投注‘双’注单将会盈利。</li>
      </ul>
      <p><strong>球门球: 单 / 双 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测45分钟内赛事的总球门球个数是单数或双数。</li>
        <li>若比赛没有球门球，结果为0，投注‘双’注单将会盈利。</li>
      </ul>
      <p><strong>最先/最后球门球</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>最多球门球球队</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将发出最多球门球。</li>
        <li>注单将按照90分钟完场赛事时间内发出最多球门球的球队做结算。</li>
        <li>选项可列为：</li>
        <ul class="ul-alpha">
          <li>球队A</li>
          <li>球队B</li>
      ...
      <ul class="ul-decimal">
        ...
        <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。</li>
        <li>范例：如果投注首个球门球时间的选项是‘赛事的第8分钟或之前’，而确实发出球门球的时间为8分钟49秒，球门球发出时间的范围属于‘第9分钟后’，因此投注将结算为输。</li>
    ...
    <!-- general rules -->
    <div class="quick_link" id="ThrowIns">界外球</div>
    <br>
    <div class="content_inner">
      <p><strong>界外球：一般规则</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>界外球：让球</strong></p>
      <ul class="ul-decimal">
        <li>预测在90分钟完场时间内哪一支球队在盘口指定的让球数发出最多界外球。</li>
        <li>所有注单将按盘口开出的让球数在相应玩法结束后结算。</li>
      </ul>
      <p><strong>界外球: 大 / 小</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>界外球: 独赢</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在90分钟比赛内获得更多的界外球，盘口提供平局投注。</li>
        <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且对赛事没有任何影响。</li>
      </ul>
      <p><strong>界外球: 独赢 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将在45分钟比赛内获得更多的界外球，盘口提供平局投注。</li>
        <li>如果赛事中断，所有注单将会被取消，除非赛事已有明确结果并且对赛事没有任何影响。</li>
      </ul>
      <p><strong>界外球: 单 / 双</strong></p>
      <ul class="ul-decimal">
        <li>预测90分钟赛事内的总界外球数是单数或双数。</li>
        <li>若比赛没有界外球，结果为：0，投注‘双’注单将会盈利。</li>
      </ul>
      <p><strong>界外球: 单 / 双 - 上半场</strong></p>
      <ul class="ul-decimal">
        <li>预测45分钟赛事内的总界外球数是单数或双数。</li>
        <li>若比赛没有界外球，结果为：0，投注‘双’注单将会盈利。</li>
      </ul>
      <p><strong>最先/最后界外球</strong></p>
      <ul class="ul-decimal">
      ...
      <p><strong>最多界外球球队</strong></p>
      <ul class="ul-decimal">
        <li>预测哪一支球队将发出最多界外球。</li>
        <li>注单将按照90分钟完场赛事时间内发出最多界外球的球队做结算。</li>
        <li>选项可列为：</li>
        <ul class="ul-alpha">
          <li>球队A</li>
          <li>球队B</li>
      ...
      <ul class="ul-decimal">
        ...
        <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。</li>
        <li>范例：如果投注首个界外球时间的选项是‘赛事的第8分钟或之前’，而确实发出界外球的时间为8分钟49秒，界外球发出时间的范围属于‘第9分钟后’，因此投注将结算为输。</li>
      ...
      <!-- general rules -->
      <div class="quick_link" id="Substitutions">替补</div>
      <div class="content_inner">
        <p><strong>替补：一般规则</strong></p>
        <ul class="ul-decimal">
          <li>替补是指在赛事进行期间，一个球员替换另一个正在赛场上的球员。</li>
          <li>注单的结算将根据官方赛果或赛事权威机构判定的结果为准。</li>
        </ul>
        <p><strong>替补：让球</strong></p>
        <ul class="ul-decimal">
          <li>预测在90分钟完场时间内哪一支球队根据盘口开出信息更换最多球员。</li>
          <li>所有注单将按盘口开出的让球数在相应玩法结束后结算。</li>
        </ul>
        <p><strong>替补: 让球 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测在45分钟完场时间内哪一支球队根据盘口开出信息更换最多球员。</li>
          <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且对赛事没有任何影响。</li>
          <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。</li>
        </ul>
        <p><strong>替补: 大 / 小</strong></p>
        <ul class="ul-decimal">
          <li>预测在90分钟内总替补的球员数将大于或小于在盘口指定的大/小盘牌数。</li>
        ...
        <p><strong>替补: 大 / 小 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测在45分钟内总替补的球员数将大于或小于在盘口指定的大/小盘牌数。</li>
          <li>如果替补的球员数多于盘口的大/小盘牌数，则为大盘。如果少于盘口的大/小盘牌数，则为小盘。</li>
          <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且对赛事没有任何影响。</li>
          <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。</li>
        </ul>
        <p><strong>替补: 独赢</strong></p>
        <ul class="ul-decimal">
          <li>预测哪一支球队将在90分钟比赛内替补更多球员，盘口提供平局。</li>
          <li>如果赛事中断前已有明确结果并且之后没有任何显著会影响投注结果的情况，总替补球员数的独赢盘注单才会被结算。若遇到任何其他情况，注单将一律被取消。</li>
        </ul>
        <p><strong><br>
        </strong><strong>替补: 独赢 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测哪一支球队将在45分钟比赛内替补更多球员，盘口提供平局。</li>
          <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且对赛事没有任何影响。</li>
          <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。</li>
        </ul>
        <p><strong>替补: 单 / 双</strong></p>
        <ul class="ul-decimal">
          <li>预测90分钟内赛事的总替补球员数是单数或双数。</li>
          <li>如果赛事中断前已有明确结果并且之后没有任何显著会影响投注结果的情况，总替补球员数的单双盘注单才会被结算。若遇到任何其他情况，注单将一律被取消。</li>
        </ul>
        <p><strong>替补: 单 / 双 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测45分钟内赛事的总替补球员数是单数或双数。</li>
          <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且对赛事没有任何影响。</li>
          <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。</li>
        </ul>
        <p><strong>最先/最后替补</strong></p>
        <ul class="ul-decimal">
        ...
        <ul class="ul-decimal">
          ...
          <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。</li>
          <li>范例：如果投注首个替补时间的选项是‘赛事的第58分钟或之前’，而确实替补的时间为58分钟49秒，替补时间的范围属于‘第59分钟后’，因此投注将结算为输。</li>
      ...
      <!-- general rules -->
      <div class="quick_link" id="Offsides">越位</div>
      <div class="content_inner">
        <p><strong>越位：一般规则</strong></p>
        <ul class="ul-decimal">
          <li>注单的结算将根据官方赛果或赛事权威机构判定的结果为准。</li>
        </ul>
        <p><strong>越位：让球</strong></p>
        <ul class="ul-decimal">
          <li>预测在90分钟完场时间内哪一支球队在盘口指定的让球数越位最多次。</li>
          <li>所有注单将按盘口开出的让球数在相应玩法结束后结算。</li>
          <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后越位对赛事没有任何影响。</li>
        </ul>
        <p><strong>越位: 让球 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测在45分钟完场时间内哪一支球队在盘口指定的让球数越位最多次。</li>
          <li>所有注单将按盘口开出的让球数在相应玩法结束后结算。</li>
          <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后越位对赛事没有任何影响。</li>
          <li>如果赛事在下半场中断，那么所有投注该盘口注单均视为有效。</li>
        </ul>
        <p><strong>越位: 大 / 小</strong></p>
        <ul class="ul-decimal">
          <li>预测90分钟内总越位次数将大于或小于在盘口指定的大/小盘牌数。</li>
        ...
        <p><strong>越位: 大 / 小 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测45分钟内总越位次数将大于或小于在盘口指定的大/小盘牌数。</li>
          <li>如果越位次数多于盘口的大/小盘牌数，则为大盘。如果少于盘口的大/小盘牌数，则为小盘。</li>
          <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后越位对赛事没有任何影响。</li>
          <li>如果赛事在下半场中断，那么所有投注该盘口注单均视为有效。</li>
        </ul>
        <p><strong>越位: 独赢</strong></p>
        <ul class="ul-decimal">
          <li>预测哪一支球队将在90分钟比赛内获得更多越位数，盘口提供平局投注。</li>
          <li>如果赛事中断前已有明确结果并且之后没有任何显著会影响投注结果的情况，总越位次数的独赢盘注单才会被结算。若遇到任何其他情况，注单将一律被取消。</li>
        </ul>
        <p><strong>越位: 独赢 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测哪一支球队将在45分钟比赛内获得更多越位数，盘口提供平局投注。</li>
          <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后越位对赛事没有任何影响。</li>
          <li>如果赛事在下半场中断，那么所有投注上半场注单均视为有效。</li>
        </ul>
        <p><strong>越位: 单 / 双</strong></p>
        <ul class="ul-decimal">
          <li>预测90分钟内赛事的总越位数是单数或双数。</li>
          <li>若比赛没有越位，结果为：0，投注‘双’注单将会盈利。</li>
          <li>如果赛事中断前已有明确结果并且之后没有任何显著会影响投注结果的情况，总越位次数的单双盘注单才会被结算。若遇到任何其他情况，注单将一律被取消。</li>
        </ul>
        <p><strong>越位: 单 / 双 - 上半场</strong></p>
        <ul class="ul-decimal">
          <li>预测45分钟内赛事的总越位数是单数或双数。</li>
          <li>若比赛没有越位，结果为：0，投注‘双’注单将会盈利。</li>
          <li>如果赛事在上半场中断，所有注单将会被取消，除非赛事已有明确结果并且之后越位对赛事没有任何影响。</li>
          <li>如果赛事在下半场中断，那么所有投注该盘口注单均视为有效。</li>
        </ul>
        <p><strong>最先/最后越位</strong></p>
        <ul class="ul-decimal">
        ...
        <ul class="ul-decimal">
          ...
          <li>出于结算的用意，赛事的第一分钟是从1秒计算到59秒。第二分钟则是从1分钟计算到1分59秒，以此类推。</li>
          <li>范例：如果投注首个越位时间的选项是‘赛事的第8分钟或之前’，而确实球员越位的时间为8分钟49秒，球员越位时间的范围属于‘第9分钟后’，因此投注将结算为输。</li>
      ...
      <!-- general rules -->
      <div class="quick_link" id="PenaltyMarkets">
        点球
      </div>
      <div class="content_inner">
        <p><strong>点球荣获</strong></p>
        <ul class="ul-decimal">
          <li>预测在90分钟完场时间内是否会罚点球。</li>
        </ul>
        <p><strong>点球大战 - 让球</strong></p>
        <ul class="ul-decimal">
        ...
        <p><strong>点球：进球/无进球</strong></p>
        <ul class="ul-decimal">
          <li>预测特定的球队是否会踢进指定的点球。</li>
          <li>根据点球是否进球来进行结算。</li>
        </ul>

        <p><strong>点球大战</strong></p>
        <ul class="ul-decimal">
          <li>预测一场比赛是否会有点球大战。</li>
          <li>无论此前是否有进行加时赛， 将根据比赛是否有点球大战来进行结算。</li>
        </ul>

        <p><strong>点球大战 – X回合</strong></p>
        <ul class="ul-decimal">
          <li>预测哪一支球队将在点球大战的X回合胜出或和局。</li>
          <li>X回合是指两个球队在该回合的点球比分。</li>
          <ul class="ul-alpha" style="list-style:none;">
            <li>范例1: (点球大战开始) - A队第一个点球和B队第一个点球为第一回合。</li>
            <li>范例2: (骤死赛开始) - A队第六个点球和B队第六个点球为第六回合。</li>
          </ul>
          <li>根据点球大战每个回合的所进的点球来进行结算。</li>
          <li>如果点球大战在指定回合前结束,投注将视为无效。</li>
        </ul>

        <p><strong>点球大战 – 结束回合</strong></p>
        <ul class="ul-decimal">
          <li>预测点球大战将的结束回合。</li>
        ...
        <!-- general rules -->
        <div class="quick_link" id="Competitions">
          比赛
        </div>
        <div class="content_inner">
          <p><strong>联赛：一般规则</strong></p>
          <ul class="ul-decimal">
            <li>赛果确认完成后将进行派彩。</li>
          ...
          <p><strong>小组赛</strong></p>
          <ul class="ul-decimal">
            <li>预测整个赛季中排名最高的球队。</li>
          </ul>
          <p>
            <strong>排名前</strong><strong>4</strong><strong>、</strong><strong>6</strong><strong>、</strong><strong>10</strong><strong>等</strong>
          </p>
          <ul class="ul-decimal">
            <li>预测整个赛季中排名在前4、6、10等的球队。</li>
          </ul>
          <p><strong>没有球队</strong><strong>X</strong><strong>的联赛冠军</strong></p>
          <ul class="ul-decimal">
            <li>预测整个赛季中，当所列出的球队或某球队从联赛表中移除后，哪一支球队将获得冠军。</li>
          </ul>
          <p><strong>联赛：最后一名球队</strong></p>
          <ul class="ul-decimal">
            <li>预测整个赛季中哪一支球队会成为最后一名。</li>
            <li>此类投注也被称为最低分。</li>
          </ul>
          <p><strong>联赛：被降级的球队</strong></p>
          <ul class="ul-decimal">
          ...
          <p><strong>联赛：最佳新秀</strong></p>
          <ul class="ul-decimal">
            <li>预测哪一支最新晋级的球队将在赛季中获得最高排名。</li>
          </ul>
          <p><strong>比赛</strong><strong> - </strong><strong>进球最多的球队</strong></p>
          <ul class="ul-decimal">
          ...
          <p><strong>比赛</strong><strong> - </strong><strong>失球最多的球队</strong></p>
          <ul class="ul-decimal">
          ...
          <p>
            <strong>比赛</strong><strong>–</strong><strong>总进球数</strong>
          </p>
          <ul class="ul-decimal">
            <li>预测在比赛中进球的数量。</li>
            <li>所有的投注以赛事官方90分钟为完场时间，包括加时、伤停补时。</li>
          ...
          <p><strong>比赛</strong><strong> - </strong><strong>帽子戏法</strong></p>
          <ul class="ul-decimal">
          ...
          <p><strong>比赛</strong><strong> - </strong><strong>总帽子戏法</strong></p>
          <ul class="ul-decimal">
          ...
          <p>
            <strong>比赛</strong><strong>–</strong><strong>总红卡数</strong>
          </p>
          <ul class="ul-decimal">
            <li>预测在比赛中红卡的数量。</li>
            <li>所有的投注以赛事官方90分钟为完场时间，包括加时、伤停补时。</li>
          ...
          <p>
            <strong>比</strong><strong>赛</strong><strong>–</strong><strong>总黄卡数</strong>
          </p>
          <ul class="ul-decimal">
            <li>预测在比赛中黄卡的数量。</li>
            <li>所有的投注以赛事官方90分钟为完场时间，包括加时、伤停补时。</li>
          ...
          <p>
            <strong>比赛</strong><strong>–</strong><strong>进球最多的城市</strong>
          </p>
          <ul class="ul-decimal">
          ...
          <p>
            <strong>比赛</strong><strong>–</strong><strong>获胜小组</strong>
          </p>
          <ul class="ul-decimal">
          ...
          <p>
            <strong>锦标赛</strong><strong>–</strong><strong>小组最后一名球队</strong>
          </p>
          <ul class="ul-decimal">
            <li>预测哪一个球队为最后一名。</li>
            <li>冠军比赛规则适用。</li>
          </ul>
          <p><strong>冠军所属地</strong></p>
          <ul class="ul-decimal">
            <li>预测比赛的冠军来自哪里。</li>
            <li>来源地可以是冠军球队的所属地区、国家或洲。</li>
            <li>冠军比赛规则使用。</li>
          </ul>
          <p><strong>比赛</strong><strong> - </strong><strong>晋级</strong></p>
          <ul class="ul-decimal">
            <li>预测那支队伍会晋级去下一轮赛事。</li>
            <li>投注包括自动晋级以及在加时赛与点球大战后的晋级。<br>
            </li>
            <br>
            <li>符合冠军规则。</li>
          </ul>
          <p><strong>比赛</strong><strong> - </strong><strong>阶段淘汰</strong></p>
          <ul class="ul-decimal">
            <li>预测比赛中该球队会在哪一个阶段被淘汰。</li>
            <li>冠军比赛规则使用。</li>
          </ul>
          <p><strong>比赛</strong><strong> - </strong><strong>提名入围。</strong></p>
          <ul class="ul-decimal">
            <li>预测哪一支球队会进入决赛。</li>
            <li>冠军比赛规则适用。</li>
          </ul>
          <p>
            <strong>比赛</strong><strong>–</strong><strong>最终裁判员</strong>
          </p>
          <ul class="ul-decimal">
            <li>预测决赛中的裁判员是哪一位。</li>
          ...
          <p><strong>直接预测排名（联赛、比赛）</strong></p>
          <ul class="ul-decimal">
            <li>预测在比赛或联赛中哪两个球队获得第1名和第2名的顺序排名。</li>
            <li>所有的投注以官方时间90分钟为准，包括加时、伤停补时。</li>
            <li>如果赛事中断，将以官方单位公布的最后赛果为准，其中包括赛事重新开始或指定的分数。</li>
          </ul>
          <p><strong>双预测排名</strong></p>
          <ul class="ul-decimal">
            <li>预测在比赛或联赛中哪两个球队为前两名的排名。</li>
            <li>所有的投注以官方时间90分钟为准，包括加时、伤停补时。</li>
            <li>如果赛事中断，将以官方单位公布的最后赛果为准，其中包括赛事重新开始或指定的分数。</li>
          </ul>
          <p><strong>最佳射手</strong></p>
          <ul class="ul-decimal">
          ...
          <p><strong>最佳射手球队</strong></p>
          <ul class="ul-decimal">
            <li>预测比赛中哪一个球员在所属球队中进球最多。</li>
            <li>所有的投注以官方时间90分钟为准，包括加时、伤停补时。</li>
            <li>进球数不包括点球。</li>
            <li>投注适用于所有比赛的球队。</li>
            <li>胜负不分规则适用；任何用于决定和局的方法不可作为结算依据，比如：计数协助。</li>
          </ul>
          <p><strong>最佳射手</strong><strong>/</strong><strong>比赛双赢</strong></p>
          <ul class="ul-decimal">
        ...
        <!-- general rules -->
        <div class="quick_link" id="">综合市场</div>
        <div class="content_inner">
          <p><strong>独赢 &amp; 进球 大/小</strong></p>
          <ul class="ul-decimal">
          ...
          <p><strong>进球 大/小 &amp; 进球 单/双</strong></p>
          <ul class="ul-decimal">
        ...
        <!-- general rules -->
        <div class="quick_link" id="OtherMarkets">
          其他
        </div>
        <div class="content_inner">
          <p><strong>特定联赛里主客队的总进球数</strong>
            本公司在某些联赛里会提供某种结合性赛事结果的投注。盘口的玩法将结合主场与客场球队在整个联赛里的赛果之后分出胜负。中立场的比赛，第一个球队被视为这一场赛事的主队。以下列出所提供的个别替补玩法规则。 </p>
          <p><strong>特定联赛里主客队的总进球数：一般规则</strong></p>
          <ul class="ul-decimal">
            <li>如果联赛中有一场赛事中断或取消，所有特定联赛里主客队的总进球数注单将被取消。</li>
            <li>比赛日程以及赛事场次将会明确的在盘口显示。例如：</li>
            <ul class="ul-alpha">
              <li>主队-周五-3场赛事</li>
              <li>客队-周五-3场赛事</li>
            </ul>
          </ul>
          <p><strong>特定联赛里主客队的进球数：让球</strong></p>
          <ul class="ul-decimal">
            <li>预测在90分钟完场时间内哪一支球队在结合整个联赛里的赛果后在盘口指定的让球数胜出。</li>
          </ul>
          <p><strong>特定联赛里主客队的进球数：进球: 大 / 小</strong></p>
          <ul class="ul-decimal">
