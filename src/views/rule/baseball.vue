<template>
  <div class="rule-info"><!--资料区-->
    <p class="b sub">棒球</p>
    <p class="b sub"><em>最后更新日期：30/08/2016</em></p>
    ...
    <ul style="margin-left: 15px;">
      ...
      <ul class="ul-decimal">
        ...
        <li>出于结算的目的，任何常规的比赛延长到第10局或更多，将被视为进入“加时赛”。</li>
      </ul>
    </ul>
  </div><!--资料区 End-->
</template>
