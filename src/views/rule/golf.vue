<template>
  <div class="rule-info"><!--资料区-->
    <p class="b sub">高尔夫球</p>
    <p class="b sub"><em>最后更新日期：12/06/2017</em></p>
    ...
    <ul class="ul-decimal">
      ...
      <li>如果锦标赛被官方中断，所有注单将被视为无效，除非盘口结算方式已有明确结果。</li>
    </ul>
    ...
    <ul style="margin-left: 15px;">
      ...
      <p class="b sub">配对赛 /2球/3球(72洞/锦标赛配对投注)</p>
      <ul class="ul-decimal">
        <li>预测哪一位球员将以最少的杆数完成锦标赛。 </li>
        <li>盘口将两名球员配对在一起作为投注选项，但球员在实际比赛中未必是同组击球。 </li>
        <li>优胜者则是以最少杆数打完72个洞（淘汰赛/附加赛也包括在内）的球员。 </li>
        <li>如果投注的球员没有在第一回合开始比赛，所有注单将被取消。 </li>
        <li>锦标赛配对投注两方选手必须完成72个洞。如果球员中有协议或因受伤理由让另一位球员提前结束比赛，所有的注单将会被视为无效。</li>
        <li>2球赛事，盘口将提供平局投注选项。</li>
        <li>3球赛事，盘口不提供平局为投注选项，若遇到打平的情况，并列第一规则的结算方式将运用于此。 </li>
      </ul>
      <p class="b sub">下一个洞的分数-单个选手市场</p>
      <ul class="ul-decimal">
