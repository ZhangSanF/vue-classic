<template>
  <div class="rule-info"><!--资料区-->
    <p class="b sub">飞镖</p>
    <p class="b sub"><em>最后更新日期：01/03/2016</em></p>
    ...
    <ul style="margin-left: 15px;">
      ...
      <p class="b sub">最高决胜镖：大/小 X</p>
      <ul style="list-style:decimal;">
        <li>预测赛事的最高决胜镖是大于或小于指定的大/小。这个最高决胜镖可能会是170。</li>
        <li>如果一个选手的名字不在市场名单里面，结果将是基于双方选手的决胜镖记录结算</li>
        <li>如果选手的名字包含在市场名单里面，这个结果将会基于特定选手的最高决胜镖</li>
        <li>如果赛事没有完成，那么所有的赌注将是无效的，除非赛事已有明确结果。</li>
      </ul>
      <p class="b sub">最高决胜镖：大/小 （X－X）</p>
      <ul style="list-style:decimal;">
