<template>
  <div class="rule-info"><!--资料区-->
    ...
    <p class="b sub"><em>最后更新日期：18/04/2018</em></p>
    <p class="b sub">概述</p>
    ...
    <ul class="ul-decimal">
      ...
      <li>在赛事有事件发生或出现其他特殊情况时，所有待确认中的注单将不被确认并视为投注失败。此事件可包含进球，红卡，点球或技术上问题等等。(其他例子并不一一详尽列出)</li>
    ...
    <ul class="ul-decimal">
      ...
      <li>例如：</li>
      <ul class="ul-none">
        <li>第一阶段-您投注5英镑，赔率15/1（可能的赢利金额为75英镑）</li>
        <li>第二阶段-您投注的对象与另一名对象同时获胜</li>
        <li>第三阶段-您本金的一半将会乘以原赔率计算，剩下的部分将输掉。因此2.5英镑乘以15/1=37.50英镑+2.5英镑的返还的本金就是总赢利。</li>
        <li>如果有2名以上的获胜者，注金将会分成相应的等份。</li>
        <li>实际上在2名获胜者的情况下，本金的一半（50%）将乘以原赔率，剩余的一半（50%）将输掉。</li><br>
      </ul>
      <li>多冠军规则并不始终适用，如果我们最终决定赛事的冠军可由获得的比分决定。（例如小组赛事）</li>
    </ul>
