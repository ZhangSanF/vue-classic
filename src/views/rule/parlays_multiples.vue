<template>
  <div class="rule-info"><!--资料区-->
    ...
    <p>这个连串过关被视为第二个赛果会影响到第一个赛果。如果曼联获得冠军杯联赛冠军，那么曼联自然而然就进入冠军杯决赛。因此，盘口仅仅为10.0。 </p><br>
    <p>本公司有权利取消有关联的连串过关投注。</p>
    <p class="b sub">连串过关</p>
    ...
    <p>过关的计算范例如下</p>
    <p class="b sub" style="font-weight:normal">范例1： 其中一个投注项为和:</p>
    ...
    <p class="b sub" style="font-weight:normal">范例2： 其中一个投注项为赢半平半</p>
    <p></p><table width="78.8%" border="0" cellspacing="1" cellpadding="0" class="demo">
      <tbody><tr style="background-color:#ff9700; font-weight:bold;">
        <th>投注项</th>
        <th>让球</th>
    ...
    <p class="b sub" style="font-weight:normal">范例3：其中一个投注项为赢半平半</p>
    <p></p><table width="78.8%" border="0" cellspacing="1" cellpadding="0" class="demo">
      <tbody><tr style="background-color:#ff9700; font-weight:bold;">
        <th>投注项</th>
        <th>让球</th>
