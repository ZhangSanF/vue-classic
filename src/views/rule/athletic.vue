<template>
  <div class="rule-info"><!--资料区-->
    ...
    <ul class="ul-decimal" >
      ...
      <li>投注二选一，赛事投注或三方对赛的盘口，以下规则将运用于此：
        <ul class="serialAlpha">
          <li>如果只有一位选手晋级决赛，投注该选手的注单将结算为赢。 </li>
          <li>如果没有选手晋级至决赛，冠军将根据(a.)完成最多回合，或(b.)资格赛中以最佳时间完成比赛的选手为准。 </li>
        </ul>
      </li>
      <li class="serialNone">(a) 回合-优胜者则是能晋级到下一回合的资格赛并且已将其他选手击败。 </li>
      <li class="serialNone">(b) 最佳时间-用于当选手在同一个资格赛但不同场次进行比赛时。以最佳时间完成比赛的选手来决定优胜者，无论选手在该场次获得的名次。 </li>
    </ul>
  </div><!--资料区 End-->
</template>
