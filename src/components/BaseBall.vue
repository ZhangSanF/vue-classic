<template>
  <div class="zhedie footballShow" v-if="matchesMsg != '' && !matchesMsg.playMaintenance">
    ...
    <div class="border" v-for="(matches, teamName) in matchesMsg" :key="teamName" :ref="matches.showContent">
      ...
      <div :class="matches.maxHeight"  v-for="(matchesInfo,key) in matches" :key="key+'bb'+matchesInfo.id">
        <!--<div class="ball_nei">-->
          <!--<p>-->
        ...
        <div class="ball_cont">
          <div class="ball_dan_c">
            ...
            <!--  <router-link class='link' :to="{path:'/moreTYBQ',query:{url:'/moreTYBQ',type:dataType, params:{obj1: matchesInfo, obj2: reqParams}}}">-->
            ...
            <div class="ball_dan_cnt">
             <div class="rqa">
               <!--v-if="playType.qcrq in gamePlayObj"-->
                <p  class="team_rq"  :class="{ggSelect: isMix == 1 &&  checkedMatches[matchesInfo.onlykey + matchesInfo.matchesDetailId + playType.qcrq + (matchesInfo.dStrong === 'H' ? '0' : '2')]}"  to='/'  @click="betDialogHandler(matchesInfo,playType.host,playType.qcrq,'rqz',matchesInfo.dIorRH)">
                  <span class="rq_b">
             ...
             <div class="rqb">
                <p  class="team_rq" :class="{ggSelect: isMix == 1 && checkedMatches[matchesInfo.onlykey + matchesInfo.matchesDetailId + playType.qcrq + (matchesInfo.dStrong === 'H' ? '1' : '3')]}"  to='/'  @click="betDialogHandler(matchesInfo,!playType.host,playType.qcrq,'rqk',matchesInfo.dIorRC)">
                  <span class="rq_b">
...
export default{
  ...
  computed:{
    ...
    checkedMatches: {
      get: function () {
        console.log(store.state.checkedMatches,"store.state.checkedMatches")
